 ...
 * @LastEditTime: 2019-12-15 01:54:40
...
function isuser() {
    ...
    if(name != ""){
        ...
        $('.label_input_user')[0].style.transform = "translate3d(1em,0,0)";
...
function ispwd() {
    ...
    if(pwd != ""){
        ...
        $('.label_input_pwd')[0].style.transform = "translate3d(0,0,0)";
        $('.label_input_pwd')[0].style.fontWeight = "normal";
        $('.label_input_pwd')[0].style.fontSize = "1.6rem";
    }
...
function ispwd2(){
    ...
    //动画定格
    if(pwd2 != ""){
        $('.pwd1')[0].style.transform = "translate3d(0,-70%,0)";
        $('.pwd1')[0].style.fontWeight = "bolder";
        $('.pwd1')[0].style.fontSize = "1.2rem";
    }else{
        $('.label_input_pwd')[1].style.transform = "translate3d(0,0,0)";
        $('.label_input_pwd')[1].style.fontWeight = "normal";
        $('.label_input_pwd')[1].style.fontSize = "1.6rem";
    }
    if ($('.pwd2')[0].value != $('.input_pwd')[0].value){
        d = false;
    }else{
        d = true;
    }
    if (d == false) {
        $("input")[2].style.border = "0.2rem solid red";
        $(".text")[2].style.display = "inline";
        $(".text")[2].innerText = "请再确认一次";
    }else{
